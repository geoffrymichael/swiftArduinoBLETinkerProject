...
class SimpleBluetoothIO: NSObject {
    ...
    var writableCharacteristicTwo: CBCharacteristic?
    ...
    //function to write to second pin/second characteristic
    func writeValueTwo(value: Int8) {
        guard let peripheral = connectedPeripheral, let characteristic = writableCharacteristicTwo else {
            return
        }
...
extension SimpleBluetoothIO: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in characteristics {
            ...
            //MARK: This is specifically selecting characteristic by its id
            if characteristic.uuid == CBUUID(string: "F14D6BE2-23BC-11EB-ADC1-0242AC120002") {
                writableCharacteristic = characteristic
            }
            
            //add reference to second bluetooth characteristic
            if characteristic.uuid == CBUUID(string: "BEB5483E-36E1-4688-B7F5-EA07361B26A8") {
                writableCharacteristicTwo = characteristic
            }
